...
export const Variant = () => {
    ...
    const handleImageUploadChange = (e, index) => {
        ...
        setVariants((prevVariants) => {
            ...
            updatedVariants[index].image = [...updatedVariants[index].image, ...previewUrls];
            return updatedVariants;
        });
    };
                        ...
                        <div className="createVariant_Container">
                            ...
                            <div className="variant">
                                <div className="variantForm">
                                        ...
                                        <div className="containerSize_Display">
                                            <div className="blockSize_Display">
                                                <ul className="sizeDisplay">
                                                    {variant && variant.size && Array.isArray(variant.size) && variant.size.map((size, index) => (
                                                        <div className="sizeSelected_Group" key={index}>
                                                            <div className="sizeBlock_displaySize">
                                                                <li>{size}</li>
                                                            </div>
                                                            <div className="containerSize_displayButton">
                                                                <button className="deleteSize_Button" onClick={() => handleDeleteSize(size)}>
                                                                    Eliminar
                                                                </button>
                                                            </div>
                                                        </div>
                                    ...
                                    <div className="divForm_Column">
                                        <label htmlFor={`fileUpload_${index}`}>Subir Archivos:</label>
                                        <input
                                            type="file"
                                        ...
                                        />
                                        {variants[index]?.image?.map((url, urlIndex) => (
                                            <div key={urlIndex} className="imageInputContainer">
                                                <input
                                                    type="text"
                                                    placeholder="URL de la imagen"
                                                    value={url || ''}
                                                    onChange={(e) => handleImageUrlChange(index, urlIndex, e.target.value)}
                                                />
                                                <button
                                                    type="button"
                                                    onClick={() => handleDeleteImageInput(index, urlIndex)}
                                                >
                                                    Eliminar
                                                </button>
                                            </div>
                                        ))}
                                        <button onClick={() => handleAddImageInput(index)}>Agregar URL de imagen</button>
                                    </div>
